...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase DB) {
        ...
        DB.execSQL("CREATE TABLE Grades(id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, username VARCHAR, APT1 VARCHAR,APT2 VARCHAR,APT3 VARCHAR,APT4 VARCHAR,APT5 VARCHAR,GPA DOUBLE)");
    }
    @Override
    ...
    public Boolean insertgrades(String username, String APT1,String APT2,String APT3,String APT4, String APT5, Double GPA ){
        SQLiteDatabase DB = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();

        contentValues.put("username", username);
        contentValues.put("APT1", String.valueOf(APT1));
        contentValues.put("APT2", APT2);
        contentValues.put("APT3", APT3);
        contentValues.put("APT4", APT4);
        contentValues.put("APT5", APT5);
    ...
    //get grades
    public Cursor getgrades( String username){
        SQLiteDatabase DB=this.getWritableDatabase();
        Cursor cursor=DB.rawQuery("SELECT * FROM Grades  WHERE username== ?", new String[]{username});

        return cursor;
    }

    //get grades
//    public Cursor getAPTGrades( String username){
//        SQLiteDatabase DB=this.getWritableDatabase();
//        Cursor cursor=DB.rawQuery("SELECT APT1, APT2, APT3, APT4, APT5 FROM Grades  WHERE username== ?", new String[]{username});
//
//        return cursor;
//    }
